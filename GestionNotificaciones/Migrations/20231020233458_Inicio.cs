    ...
    public partial class Inicio : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_NotificacionTag", x => new { x.NotificacionesId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_NotificacionTag_Notificaciones_NotificacionesId",
                        column: x => x.NotificacionesId,
                        principalTable: "Notificaciones",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_NotificacionTag_Tags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_NotificacionTag_TagsId",
                table: "NotificacionTag",
                column: "TagsId");
        }
